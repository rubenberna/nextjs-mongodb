...
const client = new mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"]("mongodb+srv://redcarrots:mongoeasy@cluster0-tujv2.gcp.mongodb.net/test?retryWrites=true&w=majority", {
...
async function database(req, res, next) {
  ...
  req.dbClient = client;
  req.db = client.db("taskbooker_landing");
  return next();
}
...
handler.post(async (req, res) => {
  ...
  let doc = await req.db.collection('content').find({
    URL: url
  }).toArray();
  res.json(doc);
});
...
/***/ 4:
/*!************************************!*\
  !*** multi ./pages/api/content.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/rubenberna/code/Redcarrots/BossData/SEO_shell/pages/api/content.js */"./pages/api/content.js");
